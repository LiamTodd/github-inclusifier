...
INCLUSIVISER_COMMENT_WATERMARK = (
    "\n*This issue comment has been generated by Inclusiviser.*"
)
ISSUE_TITLE = "Non-inclusive Language Report"
ISSUE_BODY = f"In the thread below, a summary of the non-inclusive language found in this repository has been generated, **grouped by non-inclusive language category.**{INCLUSIVISER_COMMENT_WATERMARK}"
